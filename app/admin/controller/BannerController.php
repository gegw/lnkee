...
class BannerController extends AdminBaseController
{
    ...
    public function index()
    {
        ...
        $addressId = $this->request->param('address', 0, 'intval');
        ...
        $categoryTree        = $bannerCategoryModel->bannerCategoryTree($categoryId);
        $bannerAddressModel = new BannerAddressModel();
        $addressTree        = $bannerAddressModel->bannerAddressTree($addressId);
        ...
        $this->assign('address_tree', $addressTree);
        $this->assign('category', $categoryId);
        $this->assign('address', $addressId);
    ...
    public function addPost()
    {
        if ($this->request->isPost()) {
            ...
            $post   = $data['post'];
            $result = $this->validate($post, 'Banner');
            if ($result !== true) {
                $this->error($result);
            }
            ...
            $this->success('添加成功!', url('Banner/edit', ['id' => $portalPostModel->id]));
        }
    ...
    public function edit()
    {
        ...
        $postAddress = $post->address()->alias('b')->column('b.name', 'b.id');
        $addressModel = new BannerAddressModel();
        $addressinfo = $addressModel->where('id', $post['address'])->find();
        $postAddress = $addressinfo['name'];
        ...
        $this->assign('post_address', $postAddress);
    ...
    {
        parent::listOrders(Db::name('banner'));
        $this->success("排序更新成功！", '');
    }
