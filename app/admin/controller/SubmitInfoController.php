...
use app\admin\service\SubmitInfoService;
...
class SubmitInfoController extends AdminBaseController
{
    ...
    public function index()
    {
        ...
        $bannerService = new SubmitInfoService();
    ...
    public function info()
    {
        ...
        $portalPostModel = new SubmitInfoModel();
